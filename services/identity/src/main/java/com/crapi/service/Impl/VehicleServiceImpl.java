...
public class VehicleServiceImpl implements VehicleService {
  ...
  /**
   * @return VehicleDetails when user get signup this code will create random vehicle for user and
   *     sent email with vin and pincode on register email
   */
  @Transactional
  @Override
  ...
  /**
   * @param request
   * @return status of send mail of vehicle details. This function send mail of vehicle details
