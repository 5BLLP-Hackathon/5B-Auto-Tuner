  ...
  public static String signupMailBody(VehicleDetails vehicleDetails, String name) {
    String msgBody =
        "<html><body>"
            ...
            + name
            + "<font>,"
            + "<br><font face='calibri'><p style = 'font-size:15px; color:#000;'>We are glad to have you on-board. Your newly purchased vehiche details are provided below. Please add it on your 5B Auto Tuner dashboard.</p>"
            ...
            + "<font face='calibri' style = 'font-size:15px;color:#000;'>Warm Regards,<br/><b>5B Auto Tuner - Team</b></font><font face='calibri' font color='#0000ff'></font><br/>"
